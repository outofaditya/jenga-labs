"""OPT 1.3B peak memory across sequence lengths. GB axis, model label in corner."""
import os
import re
...
if __name__ == "__main__":
    render("opt1.3b", "OPT 1.3B", ["2K", "4K", "8K", "16K", "32K"],
           "output_figures/end2end/memory/memory-opt1.3b.pdf")
