...
data = parse_log_to_data("logs/ablations/algorithm/llama2-attn.log")

# data = [
#     {"layer": 1, "threshold": 0, "memory": 0},
# ]
...
plt.tight_layout()
plt.savefig("output_figures/ablations/algorithm/algorithm-llama2-attn.pdf")
plt.close()
