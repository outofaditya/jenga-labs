...
from jenga.models.modeling_opt_get_sparsity_thresh import (
    OPTForCausalLM,
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    show_attn: bool = field(default=False)
    show_mlp: bool = field(default=False)
...
def train():
    ...
    config = get_opt_qk(
        ...
        mlp_cut=training_args.mlp_cut,
    )

    config.show_attn = training_args.show_attn
    config.show_mlp = training_args.show_mlp
