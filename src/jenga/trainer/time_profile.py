...
class Trainer:
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    global optimizer_step_time
                    optimizer_step_time = start3.elapsed_time(end3)

                    print(
                        f"forward time: {forward_time}, backward time: {backward_time}, optimizer step time: {optimizer_step_time}, total time: {forward_time + backward_time + optimizer_step_time}"
                    )
                    if step == 3:
                        exit(0)
    ...
    def training_step(
        ...
        if self.use_apex:
            ...
            backward_time = start2.elapsed_time(end2)
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        torch.cuda.synchronize()
        global forward_time
        forward_time = start1.elapsed_time(end1)
