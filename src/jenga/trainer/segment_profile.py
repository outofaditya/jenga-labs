        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    os.makedirs("logs/ablations/segment", exist_ok=True)
                    if self.segment:
                        save_path = "logs/ablations/segment/segment.pickle"
                    else:
                        save_path = "logs/ablations/segment/base.pickle"
